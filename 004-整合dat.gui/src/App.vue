...
/* 7、dat.gui动画 */
// 文档 https://github.com/dataarts/dat.gui/blob/master/API.md
const gui = new dat.GUI();
// 公共方法 https://github.com/dataarts/dat.gui/blob/master/API.md#controller
// 方法名  中文名
// name     设置名称
// onChange 发生改变
// onFinishChange 结束改变

// 7.1、add() https://github.com/dataarts/dat.gui/blob/master/API.md#GUI+add
// 构造函数
// 参数名    中文名
// object   目标对象
// property 属性
...
// max      最大值(可选)
// step     步长(可选)
gui.add(cube.position, "x", 0, 5, 0.1).name("X坐标")
    .onChange((value) => {
...
// 7.2、addColor() https://github.com/dataarts/dat.gui/blob/master/API.md#GUI+addColor
// 构造函数
// 参数名    中文名
// object   目标对象
// property 属性
